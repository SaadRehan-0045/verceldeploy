...
const API = {
  ...
  updatePost: async (id, postData) => {
    try {
      ...
      const response = await axios.put(`https://verceldeploy-black.vercel.app/posts/${postId}`, postData);
      return { isSuccess: true, data: response.data };
    } catch (error) {
  ...
  uploadFile: async (formData) => {
    try {
      const response = await axios.post('https://verceldeploy-black.vercel.app/file/upload', formData);
      return { isSuccess: true, data: response.data };
    } catch (error) {
...
const Update = () => {
  ...
  const url = post.picture ? `https://verceldeploy-black.vercel.app/file/${post.picture}` : 'https://images.unsplash.com/photo-1543128639-4cb7e6eeef1b?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bGFwdG9pJTIwc2V0dXB8ZW58MHx8MHx8&ixlib=rb-1.2.1&w=1000&q=80';
